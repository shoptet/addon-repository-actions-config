...
| slice | what | status |
| --- | --- | --- |
| [`A0`](./a0.md) | land the in-flight branches, freeze the rule set | not started |
| [`A1`](./a1.md) | ESLint 8 → 9, flat config, and the `cwd`/basePath fix | not started |
| [`A2`](./a2.md) | extract and publish the three packages | not started |
